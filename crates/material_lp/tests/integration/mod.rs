...
pub const TEST_OUTPOST_NAME: &str = "Outpost";
pub const TEST_PROBLEM_NAME: &str = "Problem";
pub const TEST_SKILL_NAME: &str = "Planetology";
pub const TEST_SYSTEM_NAME: &str = "System";

pub mod test_assert;
pub mod test_problem;
pub mod test_objective;
